...
class All_Warehouse_Adapter(var list: ArrayList<All_Warehouse_Model.Warehouse>, var activity: MainActivity,var  fragment: All_Warehouse_Fragment ): RecyclerView.Adapter<All_Warehouse_Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(fragment).load(list[position].warehouseImg).into(holder.imageView)
