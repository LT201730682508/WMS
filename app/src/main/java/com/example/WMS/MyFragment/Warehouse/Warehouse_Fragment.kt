...
import com.example.WMS.MyFragment.Warehouse.All_Warehouse.All_Warehouse_Fragment
...
class Warehouse_Fragment:Fragment() {
    ...
    lateinit var all_ware:RelativeLayout
    ...
    fun init(view:View){
        ...
        all_ware=view.findViewById(R.id.all_ware)
        create_ware=view.findViewById(R.id.create_ware)

        all_ware.setOnClickListener {
            var allWarehouseFragment= All_Warehouse_Fragment()
            (activity as MainActivity).fragment_Manager.hide_all(allWarehouseFragment)
        }
