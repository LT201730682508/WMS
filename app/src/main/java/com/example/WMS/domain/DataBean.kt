...
class DataBean {
    ...
    data class ProductIn(var id:Int,var productId:Int,var productName:String,var totalAmount:Int,var productDescription:String,
                         var inPrice:Double,var productCategory:String,var productCode:String,var productImg:String,var updateTime:String, var productTags:String,var areaId: Int,var areaName:String)
    ...
    data class ProductOut(var id:Int,var productId:Int,var productName:String,var totalAmount:Int,var productDescription:String,
                        var outPrice:Double,var productCategory:String,var productCode:String,var productImg:String,var updateTime:String, var productTags:String,var areaId: Int,var areaName:String)
    ...
    data class ProductIn_inWarehouse(var id:Int,var supplierId: String,var inPrice: Double,var amount: Int,var note: String, var areaId:Int)

    data class ProductOut_outWarehouse(var id:Int,var receiverId: String,var outPrice: Double,var amount: Int,var note: String, var areaId:Int)
