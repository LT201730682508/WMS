...
//                warehouseItems.add(warehouseItem);
    ...
    private android.os.Handler handler=new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if(warehouseItems!=null&&warehouseItems.size()>0){
                ...
                //设置适配器
                lv_video_pager.setAdapter(new WarehouseOutList_Fragment.WarehouseOutListAdapter());
            }
            else{
    ...
    class WarehouseOutListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            WarehouseOutList_Fragment.ViewHolder viewHolder;
            if(view==null){
                view=View.inflate(context, R.layout.item_inlist,null);
                viewHolder=new WarehouseOutList_Fragment.ViewHolder();
                viewHolder.iv_icon=view.findViewById(R.id.iv_icon);
                viewHolder.tv_name=view.findViewById(R.id.tv_name);
                view.setTag(viewHolder);
            }
            else{
                viewHolder = (WarehouseOutList_Fragment.ViewHolder) view.getTag();
            }
